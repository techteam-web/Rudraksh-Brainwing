  ...
  "4bhk": {
    categories: [
      // ──── LIVING ROOM (6 scenes) ────
      {
        ...
        label: "Living Room",
        type: "single",
        defaultSceneId: "9-living-camera-1",
        scenes: [
          {
          ...
          },
          {
            ...
            levels: LEVELS_2K,
            faceSize: DEFAULT_FACE_SIZE,
            initialView: { yaw: -0.888338079119869, pitch: 0, fov: 1.4479588735060953 },
            minimapPos: { x: 48, y: 36 },
            linkHotspots: [
